...
Computes Triton-based fake-quantization error tensors from original model weights for the restoration pipeline.
output :
...
def main():
    ap = argparse.ArgumentParser(
        description="Step 1  Version) - Calculate quantization error for various models using Triton."
    )
    ap.add_argument(
        "--model_name",
        type=str,
