"""
step3_1_calculate_importance.py
Calculates and ranks Shared-B group importance scores used for cumulative restoration evaluation.
output :
./output/
`-- importance_rankings.json   (default; or <output_json>)
"""
